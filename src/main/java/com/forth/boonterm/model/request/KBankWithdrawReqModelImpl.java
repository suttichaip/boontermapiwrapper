 ...
 */
public class KBankWithdrawReqModelImpl extends BaseRequestModel{
    public KBankWithdrawReqModelImpl() {
    }

    public KBankWithdrawReqModelImpl(String ref, String chan, String account, String mobile, String amount) {
